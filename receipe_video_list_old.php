...
<section class="small-banner section">
      <div class="container">
        <div class="row">
          <?php 
              $view2 = mysqli_query($connect,"SELECT * FROM fld_receipe WHERE type='video' and is_approved = 'yes' ORDER BY id ASC") or die (mysqli_error($connect));
...
<div class="col-lg-4 col-md-4 col-md-4 col-12">
        ...
        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/<?php echo $video_id; ?>" height="300px" allowfullscreen></iframe>
